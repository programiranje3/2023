...
class Musician:
    ...
    def from_str(cls, musician_string):
        ...
        return cls(n, is_band_member)


#%%
# Print objects
keith_richards = Musician('Keith Richards', is_band_member=True)
print(keith_richards)


#%%
# Run setters and getters in the debugger
keith_richards.name = 'Keith Richards'
print(keith_richards.name)

#%%
# Compare objects
print(keith_richards == Musician('Keith Richards'))
...
# print(keith_richards.__dict__)
# print(keith_richards._Musician__year)
# keith_richards._Musician__year = 1942
# print(keith_richards._Musician__year)

# print(keith._Musician__n)
# print(keith_richards._m)
# print(keith_richards.immutable_property)
...
print(keith_richards.play('Angry', *['Thank you!', 'Thanks!'], rhythm_count='One, two, three, four!',
                          love='We love you!'))
print(keith_richards.play_song('Angry', *['Thank you!', 'Thanks!'], rhythm_count='One, two, three, four!',
                               love='We love you!'))
...
print(keith_richards.__class__.__name__)
print(keith_richards.__dict__)
print(keith_richards.__dir__)


#%%
# Demonstrate @classmethod (from_str())

print(keith_richards == Musician.from_str(keith_richards.__str__()))
